              ...
              child: Scaffold(
                ...
                state.searchQuary!=null?
                 ListView(
                  children: [
                    Wrap(
                      children: List.generate(state.searchQuary!.length, (index) => SearchPageCard(book: state.searchQuary![index],)),
                    ),
                  ],
                ):const SizedBox(),
              ),
              ...
              child: Scaffold(
                ...
                body:
                 ListView(
                  children: [
                    Wrap(
                      children: List.generate(10, (index) => const SearchPageCardLoading()),
                    ),
                  ],
                ),
              ),
